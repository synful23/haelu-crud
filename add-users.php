...
<body>	
   	...
   	<div class="container" style="margin-top:50px">
		...
		if(isset($_REQUEST['msg']) and $_REQUEST['msg']=="un"){
			...
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Game is mandatory field!</div>';
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="tel form-control" name="userphone" id="userphone" x-autocompletetype="tel" placeholder="Enter Game" required>
